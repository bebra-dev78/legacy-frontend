...
// import Index from "#/layout/Profile/index";
...
export default function Profile() {
  return (
    <Container
      sx={{ height: "70vh", display: "flex", justifyContent: "center" }}
    >
      {/* <Typography variant="h4" color="text.primary" marginBottom="40px">
        Профиль
      </Typography>
      <Index /> */}
      <Stack textAlign="center" margin="auto">
        <Typography variant="h3" marginBottom="40px" color="text.primary">
